...
public partial class AdminDashboardGuideBase : ComponentBase
{
    ...
    {
        _steps = await ProgressService.GetAllStepsAsync("admin-dashboard");
        _completedCount = await ProgressService.GetCompletedCountAsync("admin-dashboard");
        _phases = GuideService.GetPhases("admin-dashboard");
    }
    ...
    {
        "admin-dashboard-phase-1" => "bg-gradient-to-r from-emerald-100 to-emerald-300",
        "admin-dashboard-phase-2" => "bg-gradient-to-r from-blue-100 to-blue-300",
        "admin-dashboard-phase-3" => "bg-gradient-to-r from-purple-100 to-purple-300",
